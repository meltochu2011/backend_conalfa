...
const io= require('socket.io')(server,{
    cors: 
    {
      origins: ['http://localhost:3002','http://localhost:4200', 'https://joockuu.vercel.app', 'https://front-conalfa.vercel.app','http://localhost:3000', 'https://web-production-a522.up.railway.app','http://localhost:3500']
    }
